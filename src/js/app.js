...
function render(variables = {}) {
  ...
  variables.name = variables.name ? variables.name : "Tu Nombre";
  variables.lastName = variables.lastName ? variables.lastName : "Tu Apellido";
  variables.role = variables.role ? variables.role : "Desarrollador Web";
  variables.city = variables.city ? variables.city : "Caracas";
  variables.country = variables.country ? variables.country : "Venezuela";
  variables.socialMediaPosition = variables.socialMediaPosition
    ? variables.socialMediaPosition
    : "left"; // Posición predeterminada
